 ...
 */
void print_Results(std::string structDat, int N, double desp_medio, double desp_var, std::string f_name, int nThreads){
...
void run_benchmark(Structure& ds, int NUM_ELEMENTOS, int VER_PRIMEROS_N, std::string structDat, std::string n_fich, int NUM_THREADS) {
    ...
    print_Results(structDat, NUM_ELEMENTOS, error_medio, desviacion, n_fich, NUM_THREADS);
}
